...
export default function PreviewPage(){
  ...
  return (
    <div className="h-[calc(100vh-4rem)] flex flex-col from-slate-50 via-blue-50 to-indigo-50">
      {/* Header */}
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 flex flex-col from-slate-50 via-blue-50 to-indigo-50">
