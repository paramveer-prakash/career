      ...
      <main className="container mx-auto px-6 py-20 max-w-7xl">
        <div className="text-center max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-20">
            <div className="text-left p-8 rounded-3xl border border-slate-200 bg-white shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 group">
