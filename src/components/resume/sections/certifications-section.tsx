...
import { Certification, Resume } from '@/services/resume-service';
...
export function CertificationsSection({ resumeId, resume }: CertificationsSectionProps) {
  // Use certifications from resume data instead of separate API call
      ...
      <div className="space-y-4">
        {certifications.length > 0 ? (
          certifications.map((certification, index) => (
            <div key={certification.id || `certification-${index}`} className="border border-gray-200 rounded-lg p-4">
